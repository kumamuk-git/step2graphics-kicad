...
class RepositoryMetadataTests(unittest.TestCase):
    ...
    def test_repository_points_to_matching_packages_document(self):
        ...
        self.assertEqual(self.repository["maintainer"]["name"], "kuma")
    ...
    def test_package_identity_matches_owner(self):
        package = self.packages["packages"][0]
        self.assertEqual(package["identifier"], "kuma.step2graphics")
        self.assertEqual(package["author"]["name"], "kuma")
